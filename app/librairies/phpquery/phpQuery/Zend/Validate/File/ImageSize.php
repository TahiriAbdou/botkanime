...
class Zend_Validate_File_ImageSize extends Zend_Validate_Abstract
{
     ...
     *
     * @param int|array $max Maximum filesize
    ...
    {
        return [$this->_minwidth, $this->_maxwidth];
    }
     ...
     *
     * @param int $minwidth  The minimum image width
     * @param int $minheight The minimum image height
     *
    ...
    public function setImageMin($minwidth, $minheight)
    {
        ...
        $this->_minwidth = max(0, (int) $minwidth);
        $this->_minheight = max(0, (int) $minheight);
     ...
     *
     * @param int $maxwidth  The maximum image width
     * @param int $maxheight The maximum image height
     *
